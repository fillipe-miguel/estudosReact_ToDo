...
const TodoItem = ({ item }) => {
  ...
  const [settingsItemShow, setSettingsItemShow] = useState(false);
  ...
  function toggleEditItemShow() {
    if (!item.done) {
      ...
      setSettingsItemShow(false);
    }
  }

  function toggleSettingsItemShow() {
    setSettingsItemShow(!settingsItemShow);
  }
      ...
      {editItemShow ? (
        ...
        <div className="item-content-container">
          ...
          <div className="setting-button-wrapper">
            <ButtonAction
              handleEffect={toggleSettingsItemShow}
